...
select top 2 a.first_name, a.last_name, a.emailaddress, a.mobile
...
select top 50 percent a.first_name, a.emailaddress, a.mobile
...
select top 10 a.first_name, a.emailaddress, a.postal_code
